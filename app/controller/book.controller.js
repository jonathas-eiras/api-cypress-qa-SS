...
exports.create = (req, res) => {
    ...
    const book = new Book({
        ...
        author: req.body.author || 'Jhon Eiras'
    });
    ...
    book.save()
        .then(oBook => {
            ...
            res.status(500).send({
                message: err.message || "Some error ocurred while creating the Book."
            });
        });
};
